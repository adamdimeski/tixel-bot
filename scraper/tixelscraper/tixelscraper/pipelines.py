...
class MetadataPipeline:
    ...
    def open_spider(self, spider):
        ...
        try:
            ...
            print("Error extracting date information")
            self.eventDate = datetime.date(2030, 12, 12)
...
class MongoPipeline:
    ...
    def close_spider(self, spider):
        ...
        query = {"eventName": self.eventName,
                 "eventDate": self.eventDate, "time": {"$lt": self.batch_time}}
    ...
    def process_item(self, item, spider):
        ...
        self.db[self.collection_name].update_one({"ticketID": item["ticketID"]}, {
